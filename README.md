# IoT and Applications — PEMRT525

**Jyothi Engineering College of Computing (JECC)**  
**Department of Electronics & Communication Engineering**  
**Semester: S5 | Credits: 5/3 | Teaching Hours: 3:0:0:0**
...
1. Equip students with a comprehensive understanding of IoT technology, including its architecture, enabling technologies, communication models, and protocols, to effectively design and deploy IoT systems.

2. Enable students to address IoT security, privacy, and vulnerability issues, and apply practical IoT solutions using platforms like Raspberry Pi for real-world applications such as smart cities.
...
### Module 1 — Introduction to IoT Technology (9 Hours) | CO1

- Definitions and Characteristics of IoT
- IoT Architectural View (3-layer, 5-layer, CISCO 7-level)
...
### Module 2 — IoT and M2M (9 Hours) | CO2

- M2M — Definition and Characteristics
- Difference between IoT and M2M
- SDN and NFV for IoT
- Smart Objects: The "Things" in IoT — Sensors, Actuators, Smart Objects
...
|------|-------------|-------|
| Part A | 2 questions from each module (8 total), all compulsory, 3 marks each | 8 × 3 = 24 |
| Part B | 2 questions from each module, attempt 1 from each, 9 marks each | 4 × 9 = 36 |
| **Total** | | **60** |
...
|---|-------|-----------|-----------|---------|
| TB1 | Internet of Things: A Hands-on Approach | Vijay Madisetti & Arshdeep Bahga | VPT | 1st Edition, 2014 |
| TB2 | IoT Fundamentals: Networking Technologies, Protocols and Use Cases for Internet of Things | David Hanes, Gonzalo Salgueiro, Patrick Grossetete, Rob Barton & Jerome Henry | Cisco Press | 1st Edition, 2017 |
| TB3 | Internet of Things: Architecture and Design Principles | Rajkamal | McGraw Hill India | 2nd Edition, 2022 |
| TB4 | Raspberry Pi Cookbook: Software and Hardware Problems and Solutions | Simon Monk | O'Reilly (SPD) | 2016 |
...
|---|-------|-----------|-----------|------|
| REF1 | The Internet of Things — Key Applications and Protocols | Olivier Hersent, David Boswarthick, Omar Elloumi | Wiley | 2012 |
| REF2 | Internet of Things: A Survey on Enabling Technologies, Protocols, and Applications | Al-Fuqaha et al. | IEEE Communications Surveys & Tutorials, pp. 2347–2376 | 2015 |
| REF3 | The Internet of Things: Converging Technologies for Smart Environments and Integrated Ecosystems | Ovidiu Vermesan & Peter Friess | River Publishers | 1st Edition, 2013 |
| REF4 | Internet of Things — From Research and Innovation to Market Deployment | Ovidiu Vermesan | River Publishers | 1st Edition, 2014 |

---

## Video Resources (NPTEL / SWAYAM)

| Module | Link |
|--------|------|
| Module 1 | https://onlinecourses.nptel.ac.in/noc22_cs53/preview |
| Module 2 | https://nptel.ac.in/courses/106105081 |
| Module 3 | https://nptel.ac.in/courses/108108098 |
...
├── README.md                          ← This file
│
├── iot and applications.pdf           ← Official course syllabus
│
├── PPT/
│   ├── Module1_Detailed_PPT.pptx      ← Detailed presentation (22 slides)
│   └── Module1_IoT_Presentation.pptx  ← Summary presentation
│
├── Teaching Note/
│   └── Module1_Complete_Study_Notes.docx  ← Complete student study notes
│                                           (all 7 topics, textbook content, Q&A)
│
└── Text Books/
    ├── Internet-of-things-a-hands-on-approach- Arshadeep.pdf  ← TB1
    ├── Cisco-press-iot-Fundamentals.pdf                        ← TB2
    ├── KCA043 Internet of things -IoT by Raj Kamal Text Book.pdf ← TB3
    ├── 2023_Monk_S_Raspberry_Pi_Cookbook_Software_and_Hardware_Problems.pdf ← TB4
    ├── IoT_survey.pdf                  ← REF2 (Al-Fuqaha et al.)
    ├── olivier-hersent-...-ref-5.pdf   ← REF1 (Hersent et al.)
    └── Converging_Technologies_...pdf  ← REF3 (Vermesan et al.)
```
...
The **Module1_Complete_Study_Notes.docx** is a self-contained student reference document. Students do not need to refer to any other textbook — all content is drawn from the prescribed textbooks with inline citations.

**Coverage:**
- Topic 1: IoT Definitions & Characteristics `[TB3, TB2, REF2]`
- Topic 2: IoT Architectural View — 3-layer, 5-layer, CISCO 7-level, Oracle, oneM2M `[TB3, TB2]`
- Topic 3: Physical Design — IoT node components, MCU, sensors, actuators, platforms `[TB3]`
- Topic 4: Logical Design — 7 Functional Blocks `[TB1, TB2]`
- Topic 5: Communication Models — Request-Response, Pub-Sub, Push-Pull, Exclusive Pair `[TB1, REF2]`
...
*Maintained by: Dept. of ECE, JECC | Course: PEMRT525 | Semester S5*
